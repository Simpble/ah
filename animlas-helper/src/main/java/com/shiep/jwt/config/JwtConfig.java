...
import com.shiep.jwt.util.JwtConstants;
...
public class JwtConfig {
    ...
    public String createToken(UserInfo userInfo) {
        ...
        return Jwts.builder()
                ...
                .claim(JwtConstants.JWT_KEY_USER_PHOTO, userInfo.getPhoto())
    ...
    public UserInfo getUserInfoFromToken(String token) {
        ...
        System.out.println(claims.get(JwtConstants.JWT_KEY_ID));
        System.out.println(claims.get(JwtConstants.JWT_KEY_USER_NAME));
        System.out.println(claims.get(JwtConstants.JWT_KEY_USER_PHOTO));
        return new UserInfo(
                ObjectUtils.toLong(claims.get(JwtConstants.JWT_KEY_ID)),
                ObjectUtils.toString(claims.get(JwtConstants.JWT_KEY_USER_NAME)));
    }
