...
public interface IReportMapper extends BaseMapper<Report> {
     ...
     * @return
     */
    List<Report> queryReportInDay(Long cityId,Integer typeId);
    List<Report> queryReport(Long cityId,Integer typeId);
    List<Report> queryReportInWeek(Long cityId,Integer typeId);
    List<Report> queryReportInMonth(Long cityId,Integer typeId);
